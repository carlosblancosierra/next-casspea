  ...
  return (
    <section className="py-12 bg-gray-100 dark:bg-main-bg-dark">
      <div className="max-w-7xl mx-auto px-1">
        <h2 className="text-center text-2xl sm:text-3xl font-bold mb-4 text-primary-text dark:text-white">Signature Boxes</h2>
        <p className="text-center text-primary-text dark:text-primary-text-light mb-8">
