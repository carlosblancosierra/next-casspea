...
const FlavourCard: React.FC<FlavourCardProps> = ({ flavour }) => {
    return (
        <div
            className="border p-4 rounded-lg flex-shrink-0 bg-main-bg shadow-md dark:bg-main-bg-dark dark:text-white dark:border-gray-700"
        ...
        >
            ...
            <p className="mt-1 text-[10px] text-primary-text md:text-xs text-center dark:text-primary-text-light">
