    ...
    <section className="py-12 px-4">
      ...
      {selected && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50" onClick={() => setSelected(null)}>
          <div className="dark:bg-gray-800 p-6 rounded-lg max-w-md w-full" onClick={e => e.stopPropagation()}>
            <button className="absolute top-2 right-2 secondary-text hover:secondary-text" onClick={() => setSelected(null)}>
              &times;
            </button>
