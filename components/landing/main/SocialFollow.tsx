...
interface SocialFollowProps { config: typeof import('../constants').LANDING_CONFIG.gold; }

export default function SocialFollow({ config }: SocialFollowProps) {
  return (
    <section className={`py-12 ${config.socialBgClass || 'bg-gray-900'} text-white px-4`}>
