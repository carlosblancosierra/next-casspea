    ...
    <section className="relative min-h-[70vh] md:min-h-[80vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-900 via-blue-700 to-blue-500 dark:bg-main-bg-dark">
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-12 mx-auto md:gap-8 xl:gap-0 md:pb-8 w-full max-w-7xl px-4 py-4">
        <div className="md:mr-10 md:col-span-6 flex flex-col justify-center items-center md:items-start text-center md:text-left">
          ...
          <div className="my-2 flex items-start gap-3 text-sm text-primary-text">
          ...
          <p className="hidden md:block md:mb-6 font-light text-sm text-primary-text lg:mb-8 md:text-base">
            {C.HERO_PARAGRAPH}
          </p>
        ...
        <div className="col-span-1 md:col-span-6 flex flex-col items-center justify-center mt-4">
          ...
          <p className="md:hidden md:mb-6 font-light text-md mt-2 text-primary-text lg:mb-8 md:text-lg lg:text-xl">
