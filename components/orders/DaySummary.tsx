...
interface DaySummaryProps {
  orders: any[]; // ideally Order[], ensure the correct type is imported if available.
}

const DaySummary: React.FC<DaySummaryProps> = ({ orders }) => {
  const { products, flavors, randomBoxes } = getDayTotals(orders);
