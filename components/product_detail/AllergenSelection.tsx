...
const AllergenSelection: React.FC<AllergenSelectionProps> = ({
    ...
    return (
        <div className="rounded-lg shadow-sm pointer-events-auto">
            {/* <h3 className="text-lg font-semibold text-secondary-text dark:text-secondary-text mb-4">
                2- Allergens
            </h3> */}
            <p className="text-sm text-secondary-text dark:text-secondary-text mb-4">2. If you have any allergies, please select the allergens you are allergic to.</p>
                ...
                <RadioGroup.Option
                    ...
                    className={({ checked }) =>
                        `${checked
                            ...
                            : 'main-bg dark:bg-transparent text-secondary-text dark:text-secondary-text'
                        }
                        ...
                        <div className="flex items-center justify-between w-full">
                            <div className="flex items-center">
                                <div className="text-sm">
                                    ...
                                    <RadioGroup.Description as="span" className={`inline ${checked ? 'text-white' : 'text-secondary-text dark:text-secondary-text'}`}>
                                        I have no allergies.
                    ...
                    {allergens.map((allergen) => (
                        <div key={allergen.id} className="flex items-center">
                            ...
                            <label
                                ...
                                className="ml-2 block text-sm font-medium text-secondary-text dark:text-secondary-text cursor-pointer"
                            >
                                {allergen.name} Free
                            </label>
                        </div>
