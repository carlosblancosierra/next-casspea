...
const ProductTemplate: React.FC<{ slug: string }> = ({ slug }) => {
	...
	if (isLoading) {
		return <div className="text-text-primary-text">Loading products...</div>;
	}

	if (error) {
		return <div className="text-text-primary-text">Error loading products.</div>;
	}
	...
	return (
		<div className="max-w-[95vw] mx-auto">
			...
			<div className="my-16">
				<h2 className="text-center text-xl font-bold text-text-primary-text">Our Flavours</h2>
				<FlavourGrid />
			</div>

			<div className="mt-10">
				<h2 className="text-center text-xl my-5 font-bold text-text-primary-text">Reviews</h2>
				<Reviews />
			</div>

			{/* Other Boxes */}
			<div className="mt-5">
				<h2 className="text-center text-xl my-5 font-bold text-text-primary-text">Need More Boxes?</h2>
			...
			{/* Chocolate Barks */}
			<div className="mt-5">
				<h2 className="text-center text-xl my-5 font-bold text-text-primary-text">Introducing our Chocolate Barks</h2>
				<div className="flex justify-center">
					<div className="mt-2 grid grid-cols-2 gap-x-2 gap-y-5 sm:grid-cols-2 lg:grid-cols-4">
			...
			{/* Hot Chocolate */}
			<div className="mt-5">
				<h2 className="text-center text-xl my-5 font-bold text-text-primary-text">Try Our Hot Chocolate</h2>
				<div className="flex justify-center">
					<div className="mt-2 grid grid-cols-2 gap-x-2 gap-y-5 sm:grid-cols-2 lg:grid-cols-4">
