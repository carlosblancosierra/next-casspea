                ...
                {!product.sold_out && (
                    <>
                        ...
                        <select
                            ...
                            className="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 bg-main-bg dark:bg-main-bg-dark shadow-sm focus:border-primary-2 focus:ring-primary-2 sm:text-sm"
                        >
