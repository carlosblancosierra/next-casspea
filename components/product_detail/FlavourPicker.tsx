                    ...
                    <div key={index} className="flavour-item flex items-center mt-4">
                        <div className="flavour-info flex-grow text-left grid grid-cols-4">
                            <div className="col-span-1">
                                <div className="mx-1">
                                    <Image src={flavour.flavour.image} alt={flavour.flavour.name} width={0} height={0} sizes="100vw" className='w-full h-auto' />
                                </div>
                                {/* <img src={flavour.flavour.image} alt={flavour.flavour.name} className="object-cover rounded-lg" /> */}
                            </div>
                            <div className='col-span-3 mt-1 mx-1 md:mx-3'>
                                <p className="font-bold text-xs md:text-sm dark:text-gray-200">{flavour.flavour.name}</p>
                            </div>
                        </div>
