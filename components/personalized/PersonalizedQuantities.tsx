  ...
  return (
    <div className="p-4 space-y-6 bg-main-bg dark:bg-main-bg-dark rounded shadow">
      <div>
        ...
        <p className="text-sm text-primary-text dark:text-primary-text-light mt-1">
          ...
          {flavours?.map((flavour) => {
            ...
            return (
              <label key={flavour.id} className="flex items-center space-x-2">
                ...
                />
                <span className="text-sm text-primary-text dark:text-primary-text-light">{flavour.name}</span>
              </label>
            );
          })}
        </div>
