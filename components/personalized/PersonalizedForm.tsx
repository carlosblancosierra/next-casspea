    ...
    return (
        <div className="flex flex-col lg:flex-row gap-8 w-full">
            ...
            <div className="w-full lg:w-1/2 space-y-6">
                ...
                <div className="space-y-4">
                    <div>
                        <label htmlFor="email" className="block text-sm font-medium text-primary-text dark:text-primary-text-light">
                            Email
                        </label>
                        <input
                            id="email"
                    ...
                    <div>
                        <label htmlFor="comments" className="block text-sm font-medium text-primary-text dark:text-primary-text-light">
                            Comments
                        </label>
                        <textarea
                            id="comments"
