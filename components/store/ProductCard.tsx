...
export default function ProductCard({ product }: { product: ProductType }) {
    return (
        <div
            key={product.name}
            className="group relative shadow-lg rounded-lg p-4 border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800"
        >
            ...
            <p className="text-md font-medium text-gray-900 dark:text-white mt-4">￡ {product.price}</p>
