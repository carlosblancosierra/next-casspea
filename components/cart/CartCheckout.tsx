        ...
        <div className="space-y-4 mt-4">
            ...
            <div className="space-y-4 rounded-lg border border-gray-200 bg-main-bg p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6 px-5">
                ...
                <div className="space-y-4">
                    ...
                    <dl className="flex items-center justify-between gap-4">
                        <dt className="text-base font-normal text-text-primary-text">Shipping</dt>
                        <dd className="text-base font-medium text-text-primary-text">
                            Next Step
                        </dd>
                    </dl>
            ...
            <div className="border-b border-gray-900/10 pb-4 dark:border-gray-700">
                <div className="flex justify-between items-center">
                    <div>
                        <h2 className="text-base font-semibold text-text-primary-text">Order Options</h2>
                    </div>
                </div>
                ...
                <div className="mt-4 space-y-4">
                    ...
                    <div className="">
                        <label className="flex items-center space-x-2">
                            ...
                            />
                            <span className="text-sm font-medium text-text-primary-text">
                                Add Shipping Date
                            </span>
                        </label>
                        {addShippingDate && (
                            ...
                            <div className="relative w-full max-w-md max-h-full">
                                <div className="relative bg-main-bg rounded-lg shadow dark:bg-gray-700">
                                    <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                                        <h3 className="text-xl font-medium text-text-primary-text">
                                    ...
                                    <div className="p-4 md:p-5">
                                        <p className="text-base leading-relaxed text-text-primary-text">
                    ...
                    <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
                        <div className="flex items-start">
                            ...
                            <div className="flex-1">
                                <h3 className="text-sm font-semibold text-text-primary-text">
                                    Email Confirmed
                                </h3>
                                <p className="mt-1 text-sm text-text-primary-text">
                                    {email}
                                </p>
                            </div>
                            <button
                                onClick={() => setEmail('')}
                                className="text-sm text-text-primary-text font-medium"
                            >
                                Change
                            </button>
                        </div>
            ...
            <div className="border-b border-gray-900/10 pb-12 dark:border-gray-700">
                <div className="space-y-4">
                    ...
                    <button
                        ...
                        className={`w-full rounded-md px-4 py-4 text-xl font-bold text-text-primary-text
                    ...
                    >
                        {isProcessing ? (
                            <>
                                <svg className="animate-spin -ml-1 mr-3 h-5 w-5 text-text-primary-text" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                    ...
                    {error && (
                        <div className="flex items-start bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-md p-3">
                            ...
                            <p className="text-sm text-text-primary-text">{error}</p>
                        </div>
                    )}
                        ...
                        <div className="inline-block align-bottom bg-main-bg dark:bg-gray-800 rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                            <div>
                                ...
                                <div className="mt-3 text-center sm:mt-5">
                                    <h3 className="text-lg leading-6 font-medium text-text-primary-text" id="modal-title">
                                        One More Step
                                    </h3>
                                    <div className="mt-2">
                            ...
                            <div className="mt-5 sm:mt-6 sm:grid sm:grid-cols-2 sm:gap-3 sm:grid-flow-row-dense">
                                <button
                                    ...
                                    className={`w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 text-base font-medium text-text-primary-text focus:outline-none focus:ring-2 focus:ring-offset-2 sm:col-start-2 sm:text-sm
                                        ${modalEmail
                                ...
                                <button
                                    type="button"
                                    onClick={() => setShowEmailModal(false)}
                                    className="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 dark:border-gray-600 shadow-sm px-4 py-2 bg-main-bg dark:bg-gray-700 text-base font-medium text-text-primary-text hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary sm:mt-0 sm:col-start-1 sm:text-sm"
                                >
                                    Cancel
                                </button>
                            </div>
