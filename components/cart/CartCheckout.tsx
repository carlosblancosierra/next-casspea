...
export default function CartCheckout() {
    ...
    // New flow: the shipping date moves to the shipping step at checkout
    ...
    const proceedToCheckout = async (emailToUse: string) => {
        ...
        try {
            const includeShippingDate = !newShippingFlow && addShippingDate;
            if (includeShippingDate || addGiftMessage) {
                const cartUpdate: CartUpdate = {
                    shipping_date: includeShippingDate ? shippingDate : undefined,
        ...
        <div className="space-y-4 mt-4">
            ...
            <div className="border-b border-gray-900/10 pb-4 dark:border-gray-700">
                ...
                <div className="mt-4 space-y-4">
                    {/* Old flow only: in the new flow the shipping date is
                        chosen on the shipping step, next to the delivery speeds */}
                    {!newShippingFlow && (
                        <div className="">
