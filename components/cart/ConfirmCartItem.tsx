...
const ConfirmCartItem: React.FC<ConfirmCartItemProps> = ({ entry }) => {
    ...
    return (
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 border border-gray-200 bg-white p-4 rounded-lg shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
            {/* Product Image */}
