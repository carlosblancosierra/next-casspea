    ...
    if (cart?.discount) {
        return (
            <div className="flex items-center justify-between  dark:bg-main-bg-dark px-3 py-2 rounded-md">
                <span className="text-xs font-medium text-primary-text dark:text-primary-text-light">
                    {cart.discount.code}
                </span>
                <button
                    onClick={handleRemoveDiscount}
                    disabled={isValidating}
                    className="text-primary-text dark:text-primary-text-light hover:text-primary-text dark:hover:text-primary-text-light focus:outline-none"
            ...
            <form onSubmit={handleSubmit} className="space-y-1">
                <div className="flex gap-2">
                    ...
                    <button
                        ...
                        className="bg-primary dark:bg-primary-2 text-primary-text-light text-xs px-4 py-2 rounded-md
                ...
                {errorMessage && (
                    <div className="flex items-center text-primary-text dark:text-primary-text-light text-xs mt-1">
