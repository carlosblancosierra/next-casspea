...
const AddressDisplay = ({ address, title }: { address: Address | undefined, title: string }) => {
    ...
    return (
        <div>
            <h3 className="font-medium text-primary-text dark:text-primary-text-light">{title}</h3>
            <div className="text-primary-text dark:text-primary-text-light">
...
const CheckoutDetails: React.FC<CheckoutDetailsProps> = ({ session }) => {
    ...
    return (
        <div className="main-bg p-6 rounded-lg shadow dark:bg-main-bg-dark">
            <h2 className="text-xl font-semibold mb-4 text-primary-text dark:text-primary-text-light">Order Details</h2>
            <div className="space-y-4">
                ...
                <div>
                    <h3 className="font-medium text-primary-text dark:text-primary-text-light">Contact</h3>
                    <p className="text-primary-text dark:text-primary-text-light">{session.email}</p>
                </div>
            </div>
        </div>
    );
