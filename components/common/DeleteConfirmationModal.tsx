      ...
      <div className="relative p-4 w-full max-w-md">
        <div className="relative bg-main-bg rounded-lg shadow dark:bg-main-bg-dark">
          <button
            type="button"
            onClick={onClose}
            className="absolute top-3 end-2.5 text-primary-text bg-transparent hover:bg-gray-200 hover:text-primary-text rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
          >
          ...
          <div className="p-4 md:p-5 text-center">
            <svg className="mx-auto mb-4 text-primary-text w-12 h-12 dark:text-primary-text" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
              <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 11V6m0 8h.01M19 10a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>
            </svg>
            <h3 className="mb-5 text-lg font-normal text-primary-text dark:text-primary-text">{title}</h3>
            <button
              onClick={onConfirm}
              type="button"
