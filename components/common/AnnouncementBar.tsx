...
export default function AnnouncementBar() {
  ...
  const renderTrustpilotRating = () => (
    <div className="flex items-center gap-x-2 justify-center">
      ...
      <a
        ...
        className="text-sm font-medium inline-block text-text-primary-text hover:underline"
  ...
  const renderContactInfo = () => (
    <p className="text-sm leading-6 w-full md:w-auto text-center text-text-primary-text">
      Tel: <a
        href={CONTACT_INFO.phone.href}
        className="underline hover:no-underline transition underline-offset-2 text-text-primary-text"
      >
  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row items-center justify-between gap-y-2 md:gap-x-6 max-w-screen-2xl mx-auto text-text-primary-text">
        <div className="flex flex-col md:flex-row flex-1 justify-center items-center gap-y-2 md:gap-x-8 w-full">
          ...
          <p
            className="w-full md:w-auto text-center px-3.5 py-1 text-sm text-text-primary-text"
          >
           Code: <button
        ...
        >
          ...
          <XMarkIcon aria-hidden="true" className="h-5 w-5 text-text-primary-text" />
        </button>
      </div>
    </div>
  )
