export default function FathersDayThankYouPage() {
  return (
    <main className="min-h-screen flex flex-col items-center mt-[10%] bg-main-bg dark:bg-main-bg-dark text-center px-4">
      <h1 className="text-3xl md:text-5xl font-bold mb-4 text-amber-700 dark:text-amber-300">
        Thank you for subscribing!
      </h1>
      <p className="text-lg md:text-xl mb-6 text-primary-text dark:text-primary-text">
