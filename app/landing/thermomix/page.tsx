...
export const metadata: Metadata = {
  ...
  openGraph: { title: C.PAGE_TITLE, description: C.PAGE_DESCRIPTION, type: 'website' },
  twitter: { card: 'summary_large_image', title: C.PAGE_TITLE, description: C.PAGE_DESCRIPTION },
};
