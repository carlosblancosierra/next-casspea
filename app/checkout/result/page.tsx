...
const CheckoutResult = () => {
  ...
  return <div className="text-primary-text dark:text-primary-text-light">Redirecting…</div>;
};

export default function CheckoutResultPage() {
  return (
    <Suspense fallback={<div className="text-primary-text dark:text-primary-text-light">Loading…</div>}>
      <CheckoutResult />
    </Suspense>
  );
}