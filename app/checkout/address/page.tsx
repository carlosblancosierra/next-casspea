...
export default function AddressPage() {
    ...
    return (
        <main className='mx-auto max-w-3xl md:py-8 py-4 bg-main-bg dark:bg-main-bg-dark min-h-screen'>
            <div className="space-y-4">
                <div>
                    <p className="text-md text-primary-text dark:text-primary-text-light">
                ...
                <div className="bg-white dark:bg-main-bg-dark p-6 rounded-lg shadow">
                    ...
                    {!useSameAddress && (
                        <div className="mt-6">
                            <h2 className="text-lg font-medium mb-4 text-primary-text dark:text-primary-text-light">Billing Address</h2>
                            <AddressForm
