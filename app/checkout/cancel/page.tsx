        ...
        <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-main-bg-dark">
            <div className="main-bg dark:bg-main-bg-dark p-8 rounded-lg shadow-lg text-center">
                ...
                <div className="mt-6 flex justify-center space-x-4">
                    <Link href="/checkout/address" className="inline-block bg-primary text-primary-text px-6 py-3 rounded-md hover:bg-primary">
                        Retry Order
                    </Link>
                    <Link href="/cart" className="inline-block bg-gray-600 text-primary-text px-6 py-3 rounded-md hover:bg-gray-700">
                        Return to Cart
                    </Link>
                    <Link href="/support" className="inline-block bg-gray-600 text-primary-text px-6 py-3 rounded-md hover:bg-gray-700">
                        Contact Support
                    </Link>
                </div>
            </div>
