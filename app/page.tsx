			...
			<section className="dark:bg-gray-900">
				<div className="grid grid-cols-1 lg:grid-cols-12 mpx-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 relative">
					<div className="md:mr-10 lg:mt-[5vh] grid-cols-1 lg:col-span-6">
						<h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-8xl dark:text-white">Luxurious Handmade Chocolates in London</h1>
						<h2 className="md:text-2xl mb-4 font-medium leading-none dark:text-white">Celebrate Every Occasion with Our Signature Gift Boxes</h2>
